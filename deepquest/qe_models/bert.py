...
class BERTModel(QEModel):

    def __init__(self, params):
        # define here attributes that are model specific
        self.use_bert = True
        self.bert_pooling = params.get('BERT_POOLING', None)
    ...
    def build(self):
        ...
        bert_layer = BertLayer(
                ...
                tune_embeddings = params.get('BERT_TUNE_EMBED', False),
                verbose=True,
        ...
        if not self.bert_pooling:
            src_annotations = Bidirectional(
                    eval(params['ENCODER_RNN_TYPE'])(768,
